		...
		<form id="scsMainOctoForm">
			<div id="scsMainTopBar" class="scsMainTopBar supsystic-plugin">
				...
				<div class="scsMainTopBarCenter">
					...
					<div class="scsMainOctoOpt">
						<label>
							<i class="fa fa-question supsystic-tooltip" title="<?php echo _e('Background color of your page. You can also set backgroun for any block on page.', SCS_LANG_CODE)?>"></i>
					...
					<div class="scsMainOctoOpt">
						<label>
							...
							<?php echo htmlScs::datepicker('params[maint_start]', array(
					...
					<div class="scsMainOctoOpt">
						<label>
							...
							<?php echo htmlScs::datepicker('params[maint_end]', array(
